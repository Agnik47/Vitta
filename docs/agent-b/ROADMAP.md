...
| M3 — Phase 1c done (Dodo ledger, real integration script run + pasted output) | **Reassigned to Agent A, 2026-07-29 (ADR-005)** | M1, Phase 0 scaffolding | `src/ledger/` — no longer this track's milestone |
