...
// real mandate gate, real Razorpay test-reserve draw, real signed receipt. The ONLY difference is
...
export const MODE_META: Record<ExecutionMode, { label: string; dot: string; blurb: string }> = {
  TEST: {
    label: "Test Mode",
    dot: "🟢",
    blurb: "Settles against your Razorpay test reserve. No merchant order is placed.",
  },
  LIVE: {
    label: "Live Mode",
    dot: "🔴",
