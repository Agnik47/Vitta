...
const MERCHANTS: LiveMerchant[] = ["blinkit", "zepto", "bigbasket"];
    ...
    <div className="flex flex-col overflow-hidden rounded-md border border-border bg-card">
      ...
      <div className="flex flex-1 flex-col gap-2 p-3">
        ...
        <div className="mt-auto flex items-center gap-2 pt-1">
          <Button size="sm" disabled={!product.available || adding} onClick={handleAdd} className="flex-1">
...
function loadingSlots(): Record<LiveMerchant, Slot> {
