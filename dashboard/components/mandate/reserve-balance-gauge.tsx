...
/**
 * Reserve remaining against the mandate's own cap — real Razorpay balance, real
  ...
  return (
    <div>
      <div className="flex items-baseline justify-between">
        <span className="text-[11px] tracking-wide text-ink-faint uppercase">Reserve balance (Razorpay, test mode)</span>
        {capInr ? (
