...
// Depends on confirming Prava's request-side idempotency-key support first — see the
// open question in docs/02-PRAVA-INTEGRATION.md. See docs/01-ARCHITECTURE.md § Phase 4.
