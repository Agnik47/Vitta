...
// reserve balance read, real Razorpay draw, real signed + chain-linked receipt. Nothing is stubbed,
...
//          spend, settles against the Razorpay test-mode reserve, and signs a receipt marked TEST
...
//
// NOTE on the word "test": every Razorpay call in this repo is test-mode-only (RazorpayLedger refuses
// anything but an rzp_test_ key — CLAUDE.md hard rule 1) — LIVE mode does not mean live money at Razorpay. The distinction here is
